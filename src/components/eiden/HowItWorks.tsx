...
export function HowItWorks({ onCommission }: { onCommission: () => void }) {
  return (
    <section id="process" className="relative bg-forest text-canvas py-14 md:py-20 overflow-hidden grain">
      <div className="absolute inset-0 paper-grid opacity-[0.08]" />
      <div className="relative mx-auto max-w-[1400px] px-5 md:px-10">
        <div className="grid md:grid-cols-12 gap-8 mb-10 pb-6 border-b border-canvas/20">
        ...
        <ol className="grid md:grid-cols-3 gap-5 md:gap-6">
          {STEPS.map((s, i) => (
            <motion.li
              ...
              className="relative rounded-2xl border border-canvas/15 p-6 md:p-7 hover:border-gold/60 transition"
            >
              ...
              <h3 className="mt-6 font-display text-2xl md:text-3xl leading-tight">{s.t}</h3>
